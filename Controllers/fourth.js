...
const fourthyears=require('../Models/fourthschema');
const fourthattendances=require('../Models/fourthattend');


const getStudents=async(req,res,next) =>{
    let students;
    try{
        students=await fourthyears.find();
    }
    catch(err){
...
const postStudents=async(req,res,next)=>{
    ...
    let existingstudent;
    try{
        existingstudent=await fouthyears.findOne({rollno:rollno});
    ...
    const createdstudent=new fourthyears({
        name,
        rollno,
        address,
        email,
...
const postattendance = async(req,res,next)=>{
    ...
    const postattendance=new fourthattendances({
        rollno,
        attend
    })
    try{
