...
const firstyears=require('../Models/firstschema');
const firstattendances=require('../Models/firstattend');


const getStudents=async(req,res,next) =>{
    let students;
    try{
        students=await firstyears.find();
    }
    catch(err){
...
const postStudents=async(req,res,next)=>{
    ...
    let existingstudent;
    try{
        existingstudent=await firstyears.findOne({rollno:rollno});
    ...
    const createdstudent=new firstyears({
        name,
        rollno,
        address,
        email,
...
const postattendance = async(req,res,next)=>{
    ...
    const postattendance=new firstattendances({
        rollno,
        attend
    })
    try{
